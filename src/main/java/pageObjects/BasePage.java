...
public class BasePage extends DriverFactory {
	...
	public void waitAndClickElement(WebElement element) throws InterruptedException {
		...
		while (!clicked && attempts < 10) {
			try {
				...
				AssertJUnit.fail("Unable to wait and click on the WebElement, using locator: " + "<" + element.toString() + ">");
			}
			attempts++;
		}
	}
	...
	public void waitAndClickElementsUsingByLocator(By by) throws InterruptedException {
		...
		while (!clicked && attempts < 10) {
			try {
				...
				AssertJUnit.fail("Unable to wait and click on the element using the By locator, element: " + "<"+ by.toString() + ">");
			}
			attempts++;
		}
	}
	...
	public void actionMoveAndClick(WebElement element) throws Exception {
		...
		try {
			...
			AssertJUnit.fail("Unable to Action Move and Click on the WebElement, Exception: " + e.getMessage());
		}
	}
	...
	public void actionMoveAndClickByLocator(By element) throws Exception {
		...
		try {
			...
			AssertJUnit.fail("Unable to Action Move and Click on the WebElement using by locator, Exception: " + e.getMessage());
		}
	}
	...
	public void jsPageScroll(int numb1, int numb2) {
		try {
			...
			AssertJUnit.fail("Unable to manually scroll to WebElement, Exception: " + e.getMessage());
		}
	}
	...
	public void waitAndclickElementUsingJS(WebElement element) {
		...
		try {
			...
			AssertJUnit.fail("Unable to JS click on the WebElement, Exception: " + e.getMessage());
		}
	}
	...
	public void closeAlertPopupBox() throws AWTException, InterruptedException {
		try {
			...
			AssertJUnit.fail("Unable to close the popup, Exception: " + e.getMessage());
		}
	}
	/**********************************************************************************
	 **GET TEXT METHODS
